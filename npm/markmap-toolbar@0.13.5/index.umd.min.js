/*! markmap-toolbar v0.13.5 | MIT License */
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(
        ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).markmap =
          t.markmap || {})
      );
})(this, function (t) {
  "use strict";
  ...
  /*! @gera2ld/jsx-dom v2.1.1 | ISC License */ var r =
      "http://www.w3.org/1999/xlink",
    A = { show: r, actuate: r, href: r };
  function n(t, e) {
    var r;
  ...
  var l = { className: "class", labelFor: "for" };
  function h(t, e, r, n) {
  ...
  function c(t, e) {
    if ((void 0 === e && (e = a), null == t || "boolean" == typeof t))
    ...
    if (
      ...
      var d,
        ...
        g = v.props;
      if (
        (e.isSvg || "svg" !== f || (e = Object.assign({}, e, { isSvg: !0 })),
        (function (t, e, r) {
          for (var A in e)
            "key" !== A &&
              "children" !== A &&
              ...
              ("dangerouslySetInnerHTML" === A
                ? (t.innerHTML = e[A].__html)
                : "innerHTML" === A || "textContent" === A || "innerText" === A
                ? (t[A] = e[A])
                : A.startsWith("on")
                ? (t[A.toLowerCase()] = e[A])
                : h(t, A, e[A], r.isSvg));
        ...
        e.isSvg &&
          "foreignObject" === f &&
          (p = Object.assign({}, p, { isSvg: !1 })),
          (u = c(g.children, p));
      }
      null != u && s(d, u);
      var m = g.ref;
      return "function" == typeof m && m(d), { type: 1, node: d };
    }
    if (Array.isArray(t))
      return {
        type: 4,
  ...
  /*! markmap-common v0.13.4 | MIT License */ Math.random()
    .toString(36)
    .slice(2, 8);
  const f = "mm-toolbar-item";
  function g({ title: t, content: e, onClick: r }) {
    return n("div", { className: f, title: t, onClick: r, children: e });
  }
  let p;
  class m {
    static create(t) {
    ...
    constructor() {
      (this.showBrand = !0),
        ...
        this.register({
          ...
          content: m.icon("M16 4h-12v12h12v-8h-8v4h2v-2h4v4h-8v-8h10z"),
          onClick: (t) => {
            const e = t.target.closest(".mm-toolbar-item"),
              r = () => e.classList.toggle("active"),
              A = r();
            this.handleRecurse(A, r);
          },
        }),
    ...
    handleRecurse(t, r) {
      const A = this.markmap;
      var n, i;
      if (!t)
        return void (
          null == (n = A.handleClick) ||
          null == (i = n.__reset) ||
          i.call(n)
        );
      const o = A.handleClick;
      if (!o) return;
      const a = (t, n) => {
        var i;
        const o = null != (i = n.data.payload) && i.fold ? 0 : 1;
        !(function (t, e, r = "children") {
          const A = (t, n) =>
            e(
              t,
              () => {
          ...
          (t.payload = e({}, t.payload, { fold: o })), r();
        }),
          A.renderData(n.data),
          r(),
          a.__reset();
  ...
  (m.defaultItems = ["zoomIn", "zoomOut", "fit", "recurse"]), (t.Toolbar = m);
});
