/*! markmap-view v0.13.5 | MIT License */
!(function (t, e) {
  "use strict";
  function n(t) {
  ...
  var r = n(e);
  /*! markmap-common v0.13.4 | MIT License */ class i {
    constructor() {
      this.listeners = [];
    }
    tap(t) {
  ...
  const p = (function (t) {
    ...
    document.head.append(u("link", { rel: "preload", as: "script", href: t }));
  });
  function f(t, e) {
    if ("script" === t.type)
      return new Promise((e, n) => {
        ...
        document.head.append(
          u("script", a({}, t.data, { onload: e, onerror: n }))
        ),
          (null != (r = t.data) && r.src) || e();
      });
    if ("iife" === t.type) {
  ...
  function m(t) {
    "style" === t.type
      ? document.head.append(u("style", { textContent: t.data }))
      : "stylesheet" === t.type &&
        document.head.append(u("link", a({ rel: "stylesheet" }, t.data)));
  }
  function g() {
    return (
      (g =
  ...
  function j(t) {
    ...
    function i() {
      const t = n("nodeSize"),
        e = n("spacing");
      return class n extends x.prototype.constructor {
        constructor(t) {
          super(t);
        }
        copy() {
    ...
    I = (t, e, n) => {
      ...
      for (; a && s; ) {
        ...
        const r =
          ...
          s.xSize / 2 +
          a.spacing(s);
        (r > 0 || (r < 0 && c)) && ((l += r), M(i, r), A(t, e, n.index, r)),
          (c = !1);
        const h = a.bottom,
          d = s.bottom;
        h <= d && ((a = R(a)), a && (o += a.relX)),
          h >= d && ((s = $(s)), s && (l += s.relX));
      }
  ...
  function U(t, e, n, r) {
    if (((e = _[e] || e), !0 === n)) t.setAttribute(e, "");
  ...
  function V(t, e) {
    if ((void 0 === e && (e = Y), null == t || "boolean" == typeof t))
      return { type: 1, node: null };
    if (t instanceof Node) return { type: 1, node: t };
    if (2 === (null == (o = t) ? void 0 : o.vtype)) {
      ...
      if (r === F) {
        ...
        if (i.children) W(a, V(i.children, e));
    ...
    if (
      ...
      return { type: 1, node: document.createTextNode("" + t) };
    if (
      (function (t) {
      ...
      var s,
        ...
        d = c.props;
      if (
        (e.isSvg || "svg" !== h || (e = Object.assign({}, e, { isSvg: !0 })),
        (function (t, e, n) {
          for (var r in e)
            "key" !== r &&
              "children" !== r &&
              ...
              ("dangerouslySetInnerHTML" === r
                ...
                : "innerHTML" === r || "textContent" === r || "innerText" === r
                ? (t[r] = e[r])
                : r.startsWith("on")
                ? (t[r.toLowerCase()] = e[r])
                : U(t, r, e[r], n.isSvg));
  ...
  var K =
    ...
    q =
      ".markmap-container{height:0;left:-100px;overflow:hidden;position:absolute;top:-100px;width:0}.markmap-container>.markmap-foreign{display:inline-block}.markmap-container>.markmap-foreign>div:last-child{white-space:nowrap}";
  function Q(t) {
    const e = t.data;
  ...
  class at {
    constructor(t, e) {
      (this.revokers = []),
        ...
        (this.viewHooks = { transformHtml: new i() }),
    ...
    initializeData(t) {
      ...
      const {
          ...
          nodeMinHeight: r,
          maxWidth: i,
          initialExpandLevel: a,
        } = this.options,
        { id: o } = this.state,
        s = J(P("div", { className: `markmap-container markmap ${o}-g` })),
        l = J(P("style", { children: [this.getStyleContent(), q].join("\n") }));
      ...
      c(t, (t, r) => {
        var i, o;
        (t.children =
          null == (i = t.children) ? void 0 : i.map((t) => g({}, t))),
          (e += 1);
        const l = J(
          P("div", {
        ...
        s.append(l),
          (t.state = g({}, t.state, { id: e, el: l.firstChild })),
          n(t);
        const c = 2 === (null == (o = t.payload) ? void 0 : o.fold);
        c
          ? (u += 1)
          : (u || (a >= 0 && t.depth >= a)) &&
            (t.payload = g({}, t.payload, { fold: 1 })),
          r(),
          c && (u -= 1);
      });
      ...
      this.viewHooks.transformHtml.call(this, p),
        ...
        c(t, (t, e, n) => {
          var i, a;
          const o = t.state.el.getBoundingClientRect();
          (t.content = t.state.el.innerHTML),
            ...
            (t.state.path = [
              null == n || null == (i = n.state) ? void 0 : i.path,
              t.state.id,
            ]
              .filter(Boolean)
              .join(".")),
            (t.state.key =
              [null == n || null == (a = n.state) ? void 0 : a.id, t.state.id]
                .filter(Boolean)
                .join(".") + t.content),
            e();
        }),
    ...
    renderData(t) {
      ...
      const p = u.descendants().reverse(),
        ...
        x = r.min(p, (t) => t.y),
        v = r.max(p, (t) => t.y + t.ySizeInner);
      Object.assign(this.state, { minX: g, maxX: y, minY: x, maxY: v }),
        s && this.fit();
      const k = (t && p.find((e) => e.data === t)) || u,
        b = null != (e = k.data.state.x0) ? e : k.x,
        z = null != (n = k.data.state.y0) ? n : k.y,
        S = this.g.selectAll(d("g")).data(p, (t) => t.data.state.key),
        w = S.enter()
          .append("g")
          .attr("data-depth", (t) => t.data.depth)
          .attr("data-path", (t) => t.data.state.path)
          .attr(
            "transform",
            (t) =>
              `translate(${z + k.ySizeInner - t.ySizeInner},${
                b + k.xSize / 2 - t.xSize
              })`
          ),
        E = this.transition(S.exit());
      E.select("line")
        .attr("x1", (t) => t.ySizeInner)
        .attr("x2", (t) => t.ySizeInner),
        E.select("foreignObject").style("opacity", 0),
        E.attr(
          "transform",
          (t) =>
            `translate(${k.y + k.ySizeInner - t.ySizeInner},${
              k.x + k.xSize / 2 - t.xSize
            })`
        ).remove();
      ...
      this.transition(X)
        .attr("x1", -1)
        .attr("x2", (t) => t.ySizeInner + 2)
        .attr("y1", (t) => t.xSize)
        .attr("y2", (t) => t.xSize)
        .attr("stroke", (t) => l(t.data))
        .attr("stroke-width", Q);
      const O = C.selectAll(d("circle"))
        .data(
          (t) => (t.data.children ? [t] : []),
          (t) => t.data.state.key
        )
      ...
      this.transition(O)
        ...
        .attr("fill", (t) => {
          var e;
          return null != (e = t.data.payload) && e.fold && t.data.children
            ? l(t.data)
            : "#fff";
        });
      const I = C.selectAll(d("foreignObject"))
        .data(
          (t) => [t],
          (t) => t.data.state.key
        )
        ...
        .attr("width", (t) => Math.max(0, t.ySizeInner - 2 * a))
        .attr("height", (t) => t.xSize);
      this.transition(I).style("opacity", 1);
      const M = this.g
        .selectAll(d("path"))
        .data(f, (t) => t.target.data.state.key)
        .join(
          (t) => {
            const e = [z + k.ySizeInner, b + k.xSize / 2];
            return t
              .insert("path", "g")
              .attr("class", "markmap-link")
              .attr("data-depth", (t) => t.target.data.depth)
              .attr("data-path", (t) => t.target.data.state.path)
              .attr("d", m({ source: e, target: e }));
          },
          (t) => t,
          (t) => {
      ...
      this.transition(M)
        ...
        .attr("stroke-width", (t) => Q(t.target))
        .attr("d", (t) => {
          const e = [
              t.source.y + t.source.ySizeInner,
              t.source.x + t.source.xSize / 2,
            ],
            n = [t.target.y, t.target.x + t.target.xSize / 2];
          return m({ source: e, target: n });
        }),
        p.forEach((t) => {
    ...
    async fit() {
      const t = this.svg.node(),
        ...
        p = r.zoomIdentity
          .translate((e - h * u) / 2 - s * u, (n - d * u) / 2 - a * u)
          .scale(u);
    ...
    async ensureView(t, e) {
      let n, i;
      if (
        (this.g.selectAll(d("g")).each(function (e) {
          e.data === t && ((n = this), (i = e));
        }),
        !n || !i)
      )
      ...
      const a = this.svg.node(),
        ...
        [u, p] = [i.x - i.xSize / 2, i.x + i.xSize / 2].map(
          (t) => t * s.k + s.y
        ),
        f = g({ left: 0, right: 0, top: 0, bottom: 0 }, e),
        m = [f.left - c, o.width - f.right - h],
        y = [f.top - u, o.height - f.bottom - p],
        x = m[0] * m[1] > 0 ? tt(m, Math.abs) / s.k : 0,
        v = y[0] * y[1] > 0 ? tt(y, Math.abs) / s.k : 0;
      if (x || v) {
        const t = s.translate(x, v);
        return this.transition(this.svg)
    ...
    async rescale(t) {
      const e = this.svg.node(),
        ...
        s = r.zoomTransform(e),
        c = s
          .translate(((a - s.x) * (1 - t)) / s.k, ((o - s.y) * (1 - t)) / s.k)
          .scale(t);
      return this.transition(this.svg)
  ...
  (at.defaultOptions = {
    ...
    (t.deriveOptions = function (t) {
      ...
      t = g({}, t);
      const { color: n } = t;
      if ("string" == typeof n) e.color = () => n;
      else if (null != n && n.length && "string" == typeof n[0]) {
        const t = r.scaleOrdinal(n);
        e.color = (e) => t(`${e.state.id}`);
      }
      return (
        ["duration", "maxWidth", "initialExpandLevel"].forEach((n) => {
          const r = t[n];
    ...
    (t.loadJS = async function (t, e) {
      ...
      n.length > 1 && n.forEach((t) => p(t.data.src)),
        (e = a({ getMarkmap: () => window.markmap }, e));
      for (const n of t) await f(n, e);
    }),
    (t.refreshHook = nt);
